...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn("z-50 min-w-32 overflow-hidden rounded-[calc(var(--radius)-4px)] border border-border bg-card p-1 text-card-foreground shadow-lg", className)}
    {...props}
  />
));
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn("z-50 min-w-32 overflow-hidden rounded-[calc(var(--radius)-4px)] border border-border bg-card p-1 text-card-foreground shadow-md", className)}
      {...props}
    />
  </DropdownMenuPrimitive.Portal>
));
